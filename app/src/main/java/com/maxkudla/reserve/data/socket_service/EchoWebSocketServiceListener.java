...
public final class EchoWebSocketServiceListener extends WebSocketListener {
    private static final int NORMAL_CLOSURE_STATUS = 1000;

    private SocketServiceListener mScocketListener;

    public EchoWebSocketServiceListener(SocketServiceListener socketServiceListener) {
