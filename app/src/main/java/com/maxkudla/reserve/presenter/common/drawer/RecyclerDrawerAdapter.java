...
class RecyclerDrawerAdapter extends RecyclerView.Adapter<RecyclerDrawerAdapter.RecyclerDrawerHolder> {

    private List<MenuItem> items;
    private OnItemMenuClick mOnItemMenuClick;

    RecyclerDrawerAdapter(List<MenuItem> items, OnItemMenuClick onItemMenuClick) {
        this.items = items;
